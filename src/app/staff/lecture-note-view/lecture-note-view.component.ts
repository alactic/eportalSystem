...
declare var $;
@Component({
  selector: 'app-lecture-note-view',
  templateUrl: './lecture-note-view.component.html',
  styleUrls: ['./lecture-note-view.component.css']
})
export class LectureNoteViewComponent implements OnInit {
  ...
  constructor(private staffservice:StaffService, private adminservice:AdminServiceService, private elem:ElementRef ) {
    this.table();
  }
